 ...
 * The site never collects card data or payment references: availability and documents are
 * confirmed first, then the client receives an official reservation letter with payment terms.
 */
